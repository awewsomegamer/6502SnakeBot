...
class mos6502
{
   private:
      ...
      typedef void (*BusWrite)(void* user, uint16_t, uint8_t);
      typedef uint8_t (*BusRead)(void* user, uint16_t);
      typedef void (*ClockCycle)(void* user, mos6502*);
      void *user;
      BusRead Read;
      BusWrite Write;
      ClockCycle Cycle;
   ...
   public:
      ...
      mos6502(void* u, BusRead r, BusWrite w, ClockCycle c = nullptr);
